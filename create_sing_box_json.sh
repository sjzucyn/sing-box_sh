#!/bin/bash
htmlid=$(curl -X PUT 'http://127.0.0.1:10010/put' -H 'User-Agent: Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Mobile Safari/537.36' -H 'Accept-Encoding: gzip, deflate, br, zstd' -H 'Content-Type: application/json' -H 'sec-ch-ua: "Chromium";v="122", "Not(A:Brand";v="24", "Google Chrome";v="122"' -H 'sec-ch-ua-platform: "Android"' -H 'sec-ch-ua-mobile: ?1' -H 'Origin: http://127.0.0.1:10010' -H 'Sec-Fetch-Site: same-origin' -H 'Sec-Fetch-Mode: cors' -H 'Sec-Fetch-Dest: empty' -H 'Referer: http://127.0.0.1:10010/' -H 'Accept-Language: zh-CN,zh;q=0.9,en;q=0.8' -d '{
